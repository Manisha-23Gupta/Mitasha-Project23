...
# user enter mobile number "<mobile>"
# And(/^user enter mobile {string} number {string}"$/) do |string1,string2|

# @LoginPage.enterPhoneOrEmail(string1,string2)
# end
