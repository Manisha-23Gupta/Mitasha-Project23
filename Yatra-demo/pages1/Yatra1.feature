...
#
#  Scenario: 02- account creation on yatra page
#    Given Launch yatra site
#    When click on MyAccount
...
#  Scenario: 02- account creation on yatra page for permanent email id
#    Given Launch yatra site
#    When click on MyAccount
#    And user can click on sign in icon
#    And user enter userid or mobile number
...
#    And user can close this scenario
  ...
  Scenario: 03- account login on yatra page
    Given Launch yatra site
    When click on MyAccount
    And user can click on sign in icon
    And user enter userid or mobile number
#     And user can click on continue
    And user can close this scenario
##
#  Scenario:  04 user should login and logout both
#    Given Launch yatra site
#    When click on MyAccount
#    And user can click on login icon
...
#    And user can close this scenario
#
### Scenario: 05 account creation on yatra page
###     Given Launch yatra site
###     When click on MyAccount
###     And user can click on sign in icon
